...
CREATE TYPE "public"."LeadEstimateStatusEnum" AS ENUM('draft', 'sent', 'viewed', 'accepted', 'declined', 'expired');
...
ALTER TABLE "addresses" ADD CONSTRAINT "address_deleted_by_fkey" FOREIGN KEY ("deleted_by") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE cascade;
ALTER TABLE "user_addresses" ADD CONSTRAINT "user_address_user_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE cascade;
ALTER TABLE "user_addresses" ADD CONSTRAINT "user_address_address_fkey" FOREIGN KEY ("address_id") REFERENCES "public"."addresses"("id") ON DELETE cascade ON UPDATE cascade;
ALTER TABLE "org_addresses" ADD CONSTRAINT "org_address_org_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE cascade ON UPDATE cascade;
ALTER TABLE "org_addresses" ADD CONSTRAINT "org_address_address_fkey" FOREIGN KEY ("address_id") REFERENCES "public"."addresses"("id") ON DELETE cascade ON UPDATE cascade;
ALTER TABLE "customer_addresses" ADD CONSTRAINT "customerAddress_customer_fkey" FOREIGN KEY ("customer_id") REFERENCES "public"."customers"("id") ON DELETE cascade ON UPDATE cascade;
ALTER TABLE "customer_addresses" ADD CONSTRAINT "customerAddress_address_fkey" FOREIGN KEY ("address_id") REFERENCES "public"."addresses"("id") ON DELETE cascade ON UPDATE cascade;
ALTER TABLE "lead_addresses" ADD CONSTRAINT "lead_address_lead_fkey" FOREIGN KEY ("lead_id") REFERENCES "public"."leads"("id") ON DELETE cascade ON UPDATE cascade;
ALTER TABLE "lead_addresses" ADD CONSTRAINT "lead_address_address_fkey" FOREIGN KEY ("address_id") REFERENCES "public"."addresses"("id") ON DELETE cascade ON UPDATE cascade;
ALTER TABLE "job_addresses" ADD CONSTRAINT "job_address_address_fkey" FOREIGN KEY ("address_id") REFERENCES "public"."addresses"("id") ON DELETE cascade ON UPDATE cascade;
ALTER TABLE "job_addresses" ADD CONSTRAINT "job_address_job_fkey" FOREIGN KEY ("job_id") REFERENCES "public"."jobs"("id") ON DELETE cascade ON UPDATE cascade;
...
ALTER TABLE "customers" ADD CONSTRAINT "customer_org_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE cascade ON UPDATE cascade;
ALTER TABLE "customers" ADD CONSTRAINT "customer_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "public"."organization_members"("id") ON DELETE set null ON UPDATE cascade;
ALTER TABLE "customers" ADD CONSTRAINT "customer_updated_by_fkey" FOREIGN KEY ("updated_by") REFERENCES "public"."organization_members"("id") ON DELETE set null ON UPDATE cascade;
ALTER TABLE "customers" ADD CONSTRAINT "customer_deleted_by_fkey" FOREIGN KEY ("deleted_by") REFERENCES "public"."organization_members"("id") ON DELETE set null ON UPDATE cascade;
ALTER TABLE "jobs" ADD CONSTRAINT "jobs_org_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE cascade ON UPDATE cascade;
ALTER TABLE "jobs" ADD CONSTRAINT "jobs_customer_fkey" FOREIGN KEY ("customer_id") REFERENCES "public"."customers"("id") ON DELETE set null ON UPDATE cascade;
ALTER TABLE "jobs" ADD CONSTRAINT "jobs_lead_fkey" FOREIGN KEY ("lead_id") REFERENCES "public"."leads"("id") ON DELETE set null ON UPDATE cascade;
ALTER TABLE "jobs" ADD CONSTRAINT "jobs_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "public"."organization_members"("id") ON DELETE set null ON UPDATE cascade;
ALTER TABLE "jobs" ADD CONSTRAINT "jobs_updated_by_fkey" FOREIGN KEY ("updated_by") REFERENCES "public"."organization_members"("id") ON DELETE set null ON UPDATE cascade;
ALTER TABLE "jobs" ADD CONSTRAINT "jobs_deleted_by_fkey" FOREIGN KEY ("deleted_by") REFERENCES "public"."organization_members"("id") ON DELETE set null ON UPDATE cascade;
...
ALTER TABLE "job_schedules" ADD CONSTRAINT "job_schedules_org_fkey" FOREIGN KEY ("org_id") REFERENCES "public"."organizations"("id") ON DELETE cascade ON UPDATE cascade;
ALTER TABLE "job_schedules" ADD CONSTRAINT "job_schedules_job_fkey" FOREIGN KEY ("job_id") REFERENCES "public"."jobs"("id") ON DELETE cascade ON UPDATE cascade;
ALTER TABLE "job_schedule_assignments" ADD CONSTRAINT "job_schedule_assignement_schedule_fkey" FOREIGN KEY ("job_schedule_id") REFERENCES "public"."job_schedules"("id") ON DELETE cascade ON UPDATE cascade;
ALTER TABLE "job_schedule_assignments" ADD CONSTRAINT "job_schedule_assignement_assignedTo_fkey" FOREIGN KEY ("assigned_to") REFERENCES "public"."organization_members"("id") ON DELETE set null ON UPDATE cascade;
ALTER TABLE "job_schedule_assignments" ADD CONSTRAINT "job_schedule_assignement_assignedBy_fkey" FOREIGN KEY ("assigned_by") REFERENCES "public"."organization_members"("id") ON DELETE set null ON UPDATE cascade;
ALTER TABLE "job_time_entries" ADD CONSTRAINT "job_time_entries_job_fkey" FOREIGN KEY ("job_id") REFERENCES "public"."jobs"("id") ON DELETE cascade ON UPDATE cascade;
ALTER TABLE "job_time_entries" ADD CONSTRAINT "job_time_entries_member_fkey" FOREIGN KEY ("member_id") REFERENCES "public"."organization_members"("id") ON DELETE cascade ON UPDATE cascade;
ALTER TABLE "job_time_entries" ADD CONSTRAINT "job_time_entries_schedule_fkey" FOREIGN KEY ("schedule_id") REFERENCES "public"."job_schedules"("id") ON DELETE cascade ON UPDATE cascade;
...
ALTER TABLE "leads" ADD CONSTRAINT "leads_updated_by_fkey" FOREIGN KEY ("updated_by") REFERENCES "public"."organization_members"("id") ON DELETE set null ON UPDATE cascade;
ALTER TABLE "leads" ADD CONSTRAINT "leads_deleted_by_fkey" FOREIGN KEY ("deleted_by") REFERENCES "public"."organization_members"("id") ON DELETE set null ON UPDATE cascade;
ALTER TABLE "lead_attachments" ADD CONSTRAINT "lead_attachment_lead_fkey" FOREIGN KEY ("lead_id") REFERENCES "public"."leads"("id") ON DELETE cascade ON UPDATE cascade;
ALTER TABLE "lead_attachments" ADD CONSTRAINT "lead_attachment_job_fkey" FOREIGN KEY ("job_id") REFERENCES "public"."jobs"("id") ON DELETE cascade ON UPDATE cascade;
...
ALTER TABLE "lead_notes" ADD CONSTRAINT "notes_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "public"."organization_members"("id") ON DELETE set null ON UPDATE cascade;
ALTER TABLE "lead_revenue_history" ADD CONSTRAINT "lead_revenue_history_lead_fkey" FOREIGN KEY ("lead_id") REFERENCES "public"."leads"("id") ON DELETE cascade ON UPDATE cascade;
ALTER TABLE "lead_revenue_history" ADD CONSTRAINT "lead_revenue_history_job_fkey" FOREIGN KEY ("job_id") REFERENCES "public"."jobs"("id") ON DELETE cascade ON UPDATE cascade;
ALTER TABLE "lead_revenue_history" ADD CONSTRAINT "lead_revenue_history_changed_by_fkey" FOREIGN KEY ("changed_by") REFERENCES "public"."organization_members"("id") ON DELETE set null ON UPDATE no action;
ALTER TABLE "lead_categories" ADD CONSTRAINT "lead_category_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "public"."organization_members"("id") ON DELETE set null ON UPDATE cascade;
...
ALTER TABLE "material_files" ADD CONSTRAINT "material_file_material_fkey" FOREIGN KEY ("material_id") REFERENCES "public"."materials"("id") ON DELETE cascade ON UPDATE cascade;
ALTER TABLE "material_files" ADD CONSTRAINT "material_file_file_fkey" FOREIGN KEY ("file_id") REFERENCES "public"."files"("id") ON DELETE cascade ON UPDATE cascade;
...
ALTER TABLE "notifications" ADD CONSTRAINT "notifications_org_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE cascade ON UPDATE cascade;
...
ALTER TABLE "organization_members" ADD CONSTRAINT "orgMember_user_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE cascade;
ALTER TABLE "organization_members" ADD CONSTRAINT "orgMember_org_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE cascade ON UPDATE cascade;
ALTER TABLE "invitations" ADD CONSTRAINT "invitation_inviter_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE cascade;
ALTER TABLE "invitations" ADD CONSTRAINT "invitation_org_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE cascade ON UPDATE cascade;
ALTER TABLE "invitations" ADD CONSTRAINT "invitation_team_fkey" FOREIGN KEY ("team_id") REFERENCES "public"."org_teams"("id") ON DELETE cascade ON UPDATE cascade;
ALTER TABLE "org_teams" ADD CONSTRAINT "orgTeam_org_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE cascade ON UPDATE cascade;
ALTER TABLE "org_team_members" ADD CONSTRAINT "orgTeamMember_team_fkey" FOREIGN KEY ("team_id") REFERENCES "public"."org_teams"("id") ON DELETE cascade ON UPDATE cascade;
ALTER TABLE "org_team_members" ADD CONSTRAINT "orgTeamMember_user_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE cascade;
...
ALTER TABLE "org_member_roles" ADD CONSTRAINT "fk_org_member_roles_member_id" FOREIGN KEY ("org_member_id") REFERENCES "public"."organization_members"("id") ON DELETE cascade ON UPDATE cascade;
...
ALTER TABLE "org_roles" ADD CONSTRAINT "orgRole_organizationId_fk" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE cascade ON UPDATE cascade;
ALTER TABLE "org_role_members" ADD CONSTRAINT "org_role_member_org_role_id_fkey" FOREIGN KEY ("role_id") REFERENCES "public"."org_roles"("id") ON DELETE cascade ON UPDATE cascade;
...
CREATE INDEX "session_active_org_id_idx" ON "sessions" USING btree ("active_org_id");
...
CREATE INDEX "address_city_idx" ON "addresses" USING btree ("city");
CREATE INDEX "address_state_idx" ON "addresses" USING btree ("state");
CREATE INDEX "address_zip_code_idx" ON "addresses" USING btree ("zip_code");
CREATE INDEX "address_country_idx" ON "addresses" USING btree ("country");
CREATE INDEX "address_coordinates_idx" ON "addresses" USING btree ("latitude","longitude");
CREATE INDEX "address_created_at_idx" ON "addresses" USING btree ("created_at");
CREATE INDEX "address_deleted_at_idx" ON "addresses" USING btree ("deleted_at");
CREATE INDEX "address_deleted_by_idx" ON "addresses" USING btree ("deleted_by");
CREATE INDEX "user_address_user_id_idx" ON "user_addresses" USING btree ("user_id");
CREATE INDEX "user_address_address_id_idx" ON "user_addresses" USING btree ("address_id");
CREATE INDEX "org_address_org_id_idx" ON "org_addresses" USING btree ("organization_id");
CREATE INDEX "org_address_address_id_idx" ON "org_addresses" USING btree ("address_id");
CREATE INDEX "org_address_is_primary_idx" ON "org_addresses" USING btree ("is_primary");
CREATE INDEX "customerAddress_customer_id_idx" ON "customer_addresses" USING btree ("customer_id");
CREATE INDEX "customerAddress_address_id_idx" ON "customer_addresses" USING btree ("address_id");
CREATE INDEX "customerAddress_created_at_idx" ON "customer_addresses" USING btree ("created_at");
CREATE INDEX "lead_address_lead_id_idx" ON "lead_addresses" USING btree ("lead_id");
CREATE INDEX "lead_address_address_id_idx" ON "lead_addresses" USING btree ("address_id");
...
CREATE INDEX "customer_org_id_idx" ON "customers" USING btree ("organization_id");
CREATE INDEX "customer_created_at_idx" ON "customers" USING btree ("created_at");
CREATE INDEX "customer_created_by_idx" ON "customers" USING btree ("created_by");
CREATE INDEX "customer_updated_by_idx" ON "customers" USING btree ("updated_by");
CREATE INDEX "customer_deleted_by_idx" ON "customers" USING btree ("deleted_by");
CREATE INDEX "customer_deleted_at_idx" ON "customers" USING btree ("deleted_at");
CREATE INDEX "jobs_org_id_idx" ON "jobs" USING btree ("organization_id");
CREATE INDEX "jobs_lead_id_idx" ON "jobs" USING btree ("lead_id");
...
CREATE INDEX "jobs_updated_by_idx" ON "jobs" USING btree ("updated_by");
CREATE INDEX "jobs_deleted_by_idx" ON "jobs" USING btree ("deleted_by");
...
CREATE UNIQUE INDEX "job_categories_organization_id_slug_unique" ON "job_categories" USING btree ("organization_id","slug");
...
CREATE INDEX "job_schedules_org_id_idx" ON "job_schedules" USING btree ("org_id");
CREATE INDEX "job_schedules_job_id_idx" ON "job_schedules" USING btree ("job_id");
CREATE INDEX "job_schedules_start_at_idx" ON "job_schedules" USING btree ("start_at");
CREATE INDEX "job_schedules_end_at_idx" ON "job_schedules" USING btree ("end_at");
CREATE INDEX "job_schedules_created_at_idx" ON "job_schedules" USING btree ("created_at");
CREATE INDEX "job_schedule_assignement_schedule_id_idx" ON "job_schedule_assignments" USING btree ("job_schedule_id");
CREATE INDEX "job_schedule_assignement_assignedTo_idx" ON "job_schedule_assignments" USING btree ("assigned_to");
CREATE INDEX "job_schedule_assignement_assignedBy_idx" ON "job_schedule_assignments" USING btree ("assigned_by");
CREATE INDEX "job_schedule_assignement_status_idx" ON "job_schedule_assignments" USING btree ("status");
CREATE INDEX "job_schedule_assignement_role_idx" ON "job_schedule_assignments" USING btree ("role");
CREATE INDEX "job_schedule_assignement_acknowledgeAt_idx" ON "job_schedule_assignments" USING btree ("acknowledge_at");
CREATE INDEX "job_schedule_assignement_created_at_idx" ON "job_schedule_assignments" USING btree ("created_at");
CREATE INDEX "job_time_entry_job_id_idx" ON "job_time_entries" USING btree ("job_id");
CREATE INDEX "job_time_entry_member_idx" ON "job_time_entries" USING btree ("member_id");
CREATE INDEX "job_time_entry_schedule_id_idx" ON "job_time_entries" USING btree ("schedule_id");
CREATE INDEX "job_time_entry_startAt_idx" ON "job_time_entries" USING btree ("start_at");
CREATE INDEX "job_time_entry_endAt_idx" ON "job_time_entries" USING btree ("end_at");
...
CREATE INDEX "leads_created_by_idx" ON "leads" USING btree ("created_by");
CREATE INDEX "leads_updated_by_idx" ON "leads" USING btree ("updated_by");
CREATE INDEX "leads_deleted_by_idx" ON "leads" USING btree ("deleted_by");
CREATE INDEX "leads_deleted_at_idx" ON "leads" USING btree ("deleted_at");
CREATE INDEX "lead_attachment_lead_id_idx" ON "lead_attachments" USING btree ("lead_id");
CREATE INDEX "lead_attachment_job_id_idx" ON "lead_attachments" USING btree ("job_id");
CREATE INDEX "lead_attachment_file_id_idx" ON "lead_attachments" USING btree ("file_id");
CREATE INDEX "lead_attachment_uploaded_at_idx" ON "lead_attachments" USING btree ("uploaded_at");
...
CREATE INDEX "notes_created_by_idx" ON "lead_notes" USING btree ("created_by");
CREATE INDEX "lead_revenue_history_lead_id_idx" ON "lead_revenue_history" USING btree ("lead_id");
CREATE INDEX "lead_revenue_history_job_id_idx" ON "lead_revenue_history" USING btree ("job_id");
...
CREATE UNIQUE INDEX "material_sku_unique" ON "materials" USING btree ("org_id","sku");
CREATE INDEX "material_name_idx" ON "materials" USING btree ("name");
CREATE INDEX "material_stock_quantity_idx" ON "materials" USING btree ("stock_quantity");
CREATE INDEX "material_minimum_stock_level_idx" ON "materials" USING btree ("minimum_stock_level");
CREATE INDEX "material_created_at_idx" ON "materials" USING btree ("created_at");
CREATE INDEX "material_file_material_id_idx" ON "material_files" USING btree ("material_id");
CREATE INDEX "material_file_file_id_idx" ON "material_files" USING btree ("file_id");
CREATE INDEX "material_file_material_id_file_id_idx" ON "material_files" USING btree ("material_id","file_id");
...
CREATE UNIQUE INDEX "org_slug_key" ON "organizations" USING btree ("slug");
CREATE INDEX "org_created_at_idx" ON "organizations" USING btree ("created_at");
CREATE UNIQUE INDEX "orgMember_user_org_id_key" ON "organization_members" USING btree ("user_id","organization_id");
CREATE INDEX "orgMember_user_id_idx" ON "organization_members" USING btree ("user_id");
CREATE INDEX "orgMember_org_id_idx" ON "organization_members" USING btree ("organization_id");
CREATE INDEX "orgMember_created_at_idx" ON "organization_members" USING btree ("created_at");
CREATE UNIQUE INDEX "invitation_email_org_key" ON "invitations" USING btree ("email","organization_id");
CREATE INDEX "invitation_org_id_idx" ON "invitations" USING btree ("organization_id");
CREATE INDEX "invitation_inviter_id_idx" ON "invitations" USING btree ("user_id");
CREATE INDEX "orgTeam_org_id_idx" ON "org_teams" USING btree ("organization_id");
CREATE INDEX "orgTeam_created_at_idx" ON "org_teams" USING btree ("created_at");
CREATE INDEX "orgTeamMember_team_id_idx" ON "org_team_members" USING btree ("team_id");
CREATE INDEX "orgTeamMember_user_id_idx" ON "org_team_members" USING btree ("user_id");
CREATE INDEX "orgTeamMember_created_at_idx" ON "org_team_members" USING btree ("created_at");
CREATE INDEX "org_member_role_unique" ON "org_member_roles" USING btree ("organization_id","org_member_id","role_id");
CREATE INDEX "org_member_role_org_id_idx" ON "org_member_roles" USING btree ("organization_id");
CREATE INDEX "org_member_role_member_id_idx" ON "org_member_roles" USING btree ("org_member_id");
CREATE INDEX "org_member_role_role_id_idx" ON "org_member_roles" USING btree ("role_id");
...
CREATE UNIQUE INDEX "role_type_name_unique" ON "roles" USING btree ("type","role_name");
...
CREATE INDEX "orgRole_organizationId_idx" ON "org_roles" USING btree ("organization_id");
CREATE INDEX "org_role_member_org_role_id_idx" ON "org_role_members" USING btree ("role_id");
CREATE INDEX "org_role_member_org_member_id_idx" ON "org_role_members" USING btree ("member_id");
CREATE INDEX "org_role_member_unique_idx" ON "org_role_members" USING btree ("role_id","member_id");
